...
const ogImage = `${baseUrl}/hero.svg`;
const organizationLogo = `${baseUrl}/brand/icarius_interlock_badge_dark.svg`;
...
const jsonLd = {
  ...
  image: ogImage,
  keywords: ["HRIS", "AI readiness", "HR transformation", "change management", "payroll data quality"],
};
...
export default function WhitePaperPage() {
  ...
  return (
    <>
      <Head>
        <title>HR AI Readiness White Paper | Icarius Consulting</title>
        <meta name="description" content={description} />
        <meta name="robots" content="index,follow" />
        <link rel="canonical" href={canonicalUrl} />
        <meta property="og:type" content="article" />
        <meta property="og:title" content="The HR leader&apos;s field guide to AI-ready systems" />
        ...
        <meta name="twitter:title" content="The HR leader&apos;s field guide to AI-ready systems" />
